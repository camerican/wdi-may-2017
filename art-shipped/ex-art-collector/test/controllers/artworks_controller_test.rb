...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { artist_id: @artwork.artist_id, completed_at: @artwork.completed_at, name: @artwork.name, status: @artwork.status } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { artist_id: @artwork.artist_id, completed_at: @artwork.completed_at, name: @artwork.name, status: @artwork.status } }
